...
| Ensure python and all associated libraries are installed on your machine.                        |
| To run the program type the following the int command Line Interface: ```python run menu.py ```  |
| Follow instructions as per menus                                                                 |
...
data.shape
``` 
<img align="left" src="/images/Screen Shots/dataShape.png" alt="Data Shape"/><img align="right" src="/images/Screen Shots/dataShapeMent.png" alt="Data Shape"/>
...
### 3.2 Violin Plots ###
<img align="right" src="images/violinPlot.png"> A violin plot is another way of representing of data, similar to the boxplot but with the addition of probability densities for the values. The wider the plot, the greater the probability of data in that area. Violin plots may be created to for each numeric attribute and grouped according to Iris class. 
...
<img align left src="/images/Screen Shots/6algoResults.png" alt="Results of 6 Algorithm Comparison"/> <img right left src="/images/Screen Shots/algoCompare.png" alt="Plotted Results of 6 Algorithm Comparison"/>

All algortihms yielded an accuracy result of 96% or greater based on the training dataset folds. The KNN model was then used to make predictions based on the validation dataset as per code below.
